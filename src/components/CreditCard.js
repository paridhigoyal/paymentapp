...
export class CreditCard extends Component {
    ...
    //     //  &&
    //     //     this.state.cvc.length===3 && this.state.zip.length===6 
    //     //     && this.state.){
    //         {
    ...
    handleSubmit = (event) => {
        ...
        // if(isValid){
        this.props.creditCard(this.state.address, this.state.city, this.state.buyerName, this.state.states)
    }
// }
            ...
            <div>
                <div id="PaymentForm">
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <Link to={`/orderthroughcreditcard`}>
                           <button type="submit">
                                Order</button>
                       </Link>
                        {/* <CreditDetails/> */}
...
export default connect(null, { creditCard })(CreditCard)
    ;